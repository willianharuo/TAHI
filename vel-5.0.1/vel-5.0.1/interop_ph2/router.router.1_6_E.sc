...
# waitevent
waitevent wait_setup1 test_TEST-TAR-ROUTER;
...
command test_TEST-TAR-ROUTER TEST-TAR-ROUTER {
    ...
    print "";
    print "BASENAME> Step 28 (Spec)";
    print "BASENAME> Configure a static route to PREFIX3:: as REF1_IF1_LLA";
    print "BASENAME> Press Enter key for configure.";
    wait wait_setup1;
    ...
    print "BASENAME> TEST-TAR-ROUTER transmits 1500 byte ICMPv6 Echo Request to LOGO_IF1_PREFIX1_GA";
    print "BASENAME> Save the result as /tmp/1.6.E.LOGO_NAME.TEST-TAR-ROUTER_NAME.result";
    print "";
    ...
    execute "TEST-TAR-ROUTER_CMD_PING1_1_6 LOGO_IF1_PREFIX1_GA | tee /tmp/1.6.E.TEST-TAR-ROUTER_NAME.LOGO_NAME.result";
    execute "TEST-TAR-ROUTER_CMD_PING1_1_6 LOGO_IF1_PREFIX1_GA | tee -a /tmp/1.6.E.TEST-TAR-ROUTER_NAME.LOGO_NAME.result";
    execute "TEST-TAR-ROUTER_CMD_PING3_1_6 LOGO_IF1_PREFIX1_GA | tee -a /tmp/1.6.E.TEST-TAR-ROUTER_NAME.LOGO_NAME.result";
    delay 2;

    print "";
    print "BASENAME> Step 31 (Spec)";
    print "BASENAME> Transmits ICMPv6 Echo Request to TEST-TAR-ROUTER_IF3_PREFIX3_GA from YOUR DEVICE.";
...
command setup_DUMPER DUMPER {
    delay 5;
    sync start_setup;
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF1 -c 10000 -s 0 -w /tmp/1.6.E.LOGO_NAME.TEST-TAR-ROUTER_NAME.Network1.dump&";
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF2 -c 10000 -s 0 -w /tmp/1.6.E.LOGO_NAME.TEST-TAR-ROUTER_NAME.Network2.dump&";
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF3 -c 10000 -s 0 -w /tmp/1.6.E.LOGO_NAME.TEST-TAR-ROUTER_NAME.Network3.dump&";
}
...
command setup_cleanup_TEST-TAR-ROUTER TEST-TAR-ROUTER {
    ...
    delay 10;
    execute "TEST-TAR-ROUTER_CMD_1_6_E_ADD_ROUTE";
    delay 2;
