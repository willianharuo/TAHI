...
command test_TEST-TAR-ROUTER TEST-TAR-ROUTER {
    ...
    # Step 2
    print "";
    print "BASENAME> Step 21.1 (Spec)";
    print "BASENAME> Enable YOUR DEVICE interface on Network1.";
    print "BASENAME> Press Enter key for continue.";
    wait wait_step2;

    print "";
    print "BASENAME> Step 21.2 (Spec)";
    ...
    print "";
    print "BASENAME> Step 23 and 24 (Step)";
    print "BASENAME> Transmitting ICMPv6 Echo Request finished.";

    # Step 1 reverse
    print "";
    print "BASENAME> Step 20 (Spec) reverse";
    print "BASENAME> Disable YOUR DEVICE interface connected to Network1.";
    print "BASENAME> Press Enter key for continue.";
    wait wait_step1_rev;
    ...
    # Step 2 reverse
    print "";
    print "BASENAME> Step 21.1 (Spec) reverse";
    print "BASENAME> TEST-TAR-ROUTER enables interface on Network1.";
    ...
    print "";
    print "BASENAME> Step 21.2 (Spec) reverse";
    print "BASENAME> Enable YOUR DEVICE interface on Network1.";
    print "BASENAME> Press Enter key for continue.";
    wait wait_step2_rev;
    ...
    # Step 3 reverse
    print "";
    print "BASENAME> Step 22 (Spec) reverse";
    print "BASENAME> Allow time for all devices on Network1 to perform Stateless Address";
    print "BASENAME> Autoconfiguration and Duplicate Address Detection.";
    print "BASENAME> Press Enter key for continue.";
    wait wait_step3_rev;
    ...
    print "";
    print "BASENAME> Step 23 and 24 (Step) reverse";
    print "BASENAME> Transmitting ICMPv6 Echo Request finished.";
...
command test_REF1 REF1 {
    ...
    execute "/bin/sh -c ping6 -c 5 -I REF1_IF1 TEST-TAR-ROUTER_IF1_LLA | tee /tmp/1.2.C.REF.TEST-TAR-ROUTER_NAME.result";
    delay 2;
    ...
    execute "/bin/sh -c ping6 -c 5 -I REF1_IF1 TEST-TAR-ROUTER_IF1_LLA | tee -a /tmp/1.2.C.REF.TEST-TAR-ROUTER_NAME.result";
    delay 2;
...
command setup_DUMPER DUMPER {
    delay 5;
    sync start_setup;
    execute "tcpdump -i DUMPER_IF1 -c 10000 -s 0 -w /tmp/1.2.C.LOGO_NAME.TEST-TAR-ROUTER_NAME.Network1.dump";
}
