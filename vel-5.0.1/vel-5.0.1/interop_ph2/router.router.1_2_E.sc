...
command test_TEST-TAR-ROUTER TEST-TAR-ROUTER {
    ...
    # Step 2
    print "";
    print "BASENAME> Step 2.1";
    print "BASENAME> Enable YOUR DEVICE interface on Network1.";
    print "BASENAME> Press Enter key for continue.";
    wait wait_step2;

    print "";
    print "BASENAME> Step 2.2";
    print "BASENAME> TEST-TAR-ROUTER enables interface on Network1.";
    ...
    # Step 2 reverse
    print "";
    print "BASENAME> Step 2.1 reverse";
    print "BASENAME> TEST-TAR-ROUTER enables interface on Network1.";
    ...
    print "";
    print "BASENAME> Step 2.2 reverse";
    print "BASENAME> Enable YOUR DEVICE interface on Network1.";
    print "BASENAME> Press Enter key for continue.";
    wait wait_step2_rev;
...
command test_REF1 REF1 {
    ...
    print "";
    execute "/bin/sh -c ping6 -c 5 -I REF1_IF1 LOGO_IF1_LLA | tee /tmp/1.2.E.REF.LOGO_NAME.result";
    execute "/bin/sh -c ping6 -c 5 -I REF1_IF1 TEST-TAR-ROUTER_IF1_LLA | tee /tmp/1.2.E.REF.TEST-TAR-ROUTER_NAME.result";
    delay 2;
    ...
    delay 2;
    print "";
    print "BASENAME> REF1 transmits ICMPv6 Echo Request to TEST-TAR-ROUTER_IF1_LLA.";
    print "";
    execute "/bin/sh -c ping6 -c 5 -I REF1_IF1 LOGO_IF1_LLA | tee -a /tmp/1.2.E.REF.LOGO_NAME.result";
    execute "/bin/sh -c ping6 -c 5 -I REF1_IF1 TEST-TAR-ROUTER_IF1_LLA | tee -a /tmp/1.2.E.REF.TEST-TAR-ROUTER_NAME.result";
    delay 2;
...
command setup_DUMPER DUMPER {
    delay 5;
    sync start_setup;
    execute "tcpdump -i DUMPER_IF1 -c 10000 -s 0 -w /tmp/1.2.E.LOGO_NAME.TEST-TAR-ROUTER_NAME.Network1.dump";
}
