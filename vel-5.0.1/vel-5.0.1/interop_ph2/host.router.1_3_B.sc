...
command test_REF1 REF1 {
    ...
    execute "/bin/sh -c ping6 -c 5 LOGO_IF1_PREFIX1_GA | tee /tmp/1.3.B.REF.LOGO_NAME.result";

    delay 2;

    execute "/bin/sh -c ping6 -c 5 LOGO_IF1_PREFIX2_GA | tee -a /tmp/1.3.B.REF.LOGO_NAME.result";
...
command setup_DUMPER DUMPER {
    delay 5;
    sync start_setup;
    execute "tcpdump -i DUMPER_IF1 -c 10000 -s 0 -w /tmp/1.3.B.LOGO_NAME.TEST-TAR-ROUTER_NAME.Network1.dump";
}
...
command setup_cleanup_TEST-TAR-ROUTER TEST-TAR-ROUTER {
    ...
    execute "TEST-TAR-ROUTER_CMD_IFCONFIG_IF1_PREFIX2_GA_ADD";

    delay 2;
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_1";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_2";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_3";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_4";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_5";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_6";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_7";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_8";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_9";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_A";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_B";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_C";
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_3_B_D";
