...
command test_REF2 REF2 {
    ...
    execute "/bin/sh -c ping6 -c 5 LOGO_IF1_PREFIX1_GA | tee /tmp/1.4.A.REF.LOGO_NAME.result";
    delay 1;
...
command setup_DUMPER DUMPER {
    delay 5;
    sync start_setup;
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF1 -c 10000 -s 0 -w /tmp/1.4.A.LOGO_NAME.TEST-TAR-ROUTER_NAME.Network1.dump&";
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF2 -c 10000 -s 0 -w /tmp/1.4.A.LOGO_NAME.TEST-TAR-ROUTER_NAME.Network2.dump&";
}
...
command setup_cleanup_TEST-TAR-ROUTER TEST-TAR-ROUTER {
    ...
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_4_6_RL600";
    ...
    execute "TEST-TAR-ROUTER_CMD_RTADVD_CONF_1_4_C_RL600";
