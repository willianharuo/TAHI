...
command test_TEST-TAR-HOST TEST-TAR-HOST {
    ...
    # Step 2
    print "";
    print "BASENAME> Step 2 1/2 (Spec)";
    print "BASENAME> Enable YOUR DEVICE interface on Network1.";
    print "BASENAME> Press Enter key for continue.";
    wait wait_step2;

    print "";
    print "BASENAME> Step 2 2/2 (Spec)";
    ...
    print "";
    print "BASENAME> Step 4 and 5 (Spec)";
    print "BASENAME> Transmitting ICMPv6 Echo Request finished.";

    # Step 1 reverse
    print "";
    print "BASENAME> Step 1 reverse (Spec)";
    print "BASENAME> Disable YOUR DEVICE interface connected to Network1.";
    print "BASENAME> Press Enter key for continue.";
    wait wait_step1_rev;
    ...
    # Step 2 reverse
    print "";
    print "BASENAME> Step 2 1/2 reverse (Spec)";
    print "BASENAME> TEST-TAR-HOST enables interface on Network1.";
    ...
    print "";
    print "BASENAME> Step 2 2/2 reverse (Spec)";
    print "BASENAME> Enable YOUR DEVICE interface on Network1.";
    print "BASENAME> Press Enter key for continue.";
    wait wait_step2_rev;
    ...
    # Step 3 reverse
    print "";
    print "BASENAME> Step 3 reverse (Spec)";
    print "BASENAME> Allow time for all devices on Network1 to perform Stateless Address";
    print "BASENAME> Autoconfiguration and Duplicate Address Detection.";
    print "BASENAME> Press Enter key for continue.";
    wait wait_step3_rev;
    ...
    print "";
    print "BASENAME> Step 4 and 5 reverse (Spec)";
    print "BASENAME> Transmitting ICMPv6 Echo Request finished.";
...
command test_REF1 REF1 {
    ...
    print "";
    execute "/bin/sh -c ping6 -c 5 -I REF1_IF1 LOGO_IF1_LLA | tee /tmp/1.2.A.REF.LOGO_NAME.result";
    execute "/bin/sh -c ping6 -c 5 -I REF1_IF1 TEST-TAR-HOST_IF1_LLA | tee /tmp/1.2.A.REF.TEST-TAR-HOST_NAME.result";
    delay 2;
    ...
    print "";
    execute "/bin/sh -c ping6 -c 5 -I REF1_IF1 LOGO_IF1_LLA | tee -a /tmp/1.2.A.REF.LOGO_NAME.result";
    execute "/bin/sh -c ping6 -c 5 -I REF1_IF1 TEST-TAR-HOST_IF1_LLA | tee -a /tmp/1.2.A.REF.TEST-TAR-HOST_NAME.result";
    delay 2;
...
command setup_DUMPER DUMPER {
    delay 5;
    sync start_setup;
    execute "tcpdump -i DUMPER_IF1 -c 10000 -s 0 -w /tmp/1.2.A.LOGO_NAME.TEST-TAR-HOST_NAME.Network1.dump";
}
